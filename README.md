...
2.
с помощью MaxTimeMS сделать автоматическую отмену запросов, это улучшит использование ресурсов.

Значит с помощью MaxTimeMS могу указать, сколько позволено выполнять запрос.
